% mpc_1_forces - a fast optimizer generated by FORCES Pro through Y2F
%
%   OUTPUT = mpc_1_forces(PARAMS) solves a multistage problem
%   subject to the parameters supplied in a cell array with the following elements:
%       PARAMS{1} is x0 (column vector of length 3)
%
%   OUTPUT is a cell array containg the values of the last iteration of the solver where
%       OUTPUT{1} is output1 (matrix of size [2 x 29])
%
%   [OUTPUT, EXITFLAG] = mpc_1_forces(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = mpc_1_forces(PARAMS) returns 
