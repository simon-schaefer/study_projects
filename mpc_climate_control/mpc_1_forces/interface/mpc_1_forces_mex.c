/*
 This is an interface for mpc_1_forces that is used by optimizerFORCES to call the solver
*/ 
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) {
	...
	if( !mxIsCell(param_values) ) {
		mexErrMsgTxt("mpc_1_forces requires a cell array as input.");
	}
	...
	plhs[0] = mxCreateDoubleMatrix(2, 29, mxREAL);
	copyCArrayToM(output.output1, mxGetPr(plhs[0]), 58);
